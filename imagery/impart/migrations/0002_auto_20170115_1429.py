...
class Migration(migrations.Migration):
    ...
    dependencies = [("impart", "0001_initial")]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="impart.Artist"
            ),
        ),
        migrations.AddField(
            model_name="art",
            name="land_price",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="impart.LandPrice"
            ),
        ),
        migrations.AddField(
            model_name="art",
