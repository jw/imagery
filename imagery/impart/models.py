...
class Dated(models.Model):
    ...
    creation_date = models.DateTimeField(
        "Creation date", help_text="The model creation date.", default=timezone.now
    )
...
class News(Dated):
    ...
    location = models.CharField(
        max_length=1024, help_text="The location where the news took/will take place."
    )
    ...
    active = models.BooleanField(
        default=True, help_text="If set the news will be shown, otherwise it will not."
    )
    archived = models.BooleanField(
        default=False, help_text="If set the news will be part of the archive section."
    )
...
class Manifest(Dated):
    ...
    active = models.BooleanField(
        default=True,
        help_text="If set the manifest will be shown, otherwise it will not.",
    )
    archived = models.BooleanField(
        default=False,
    ...
    def __str__(self):
        return (
            self.header
            if self.header
            else "Manifest from {}.".format(self.creation_date)
        )
...
class LandPrice(models.Model):
    ...
    body_english = RichTextField(
        max_length=4096, help_text="Some explanation of the landprice in English."
    )
    body_dutch = RichTextField(
        max_length=4069, help_text="Some explanation of the landprice in Dutch."
    )
...
class Content(models.Model):
    ...
    section = models.CharField(
        max_length=2,
        choices=CONTENT_SECTION,
        null=False,
        blank=False,
        help_text="The section this content is part of.",
    )
    CONTENT_LANGUAGE = (("--", "No language"), ("EN", "English"), ("NL", "Nederlands"))
    language = models.CharField(
        max_length=2,
        choices=CONTENT_LANGUAGE,
        null=False,
        blank=False,
    ...
    identifier = models.CharField(
        max_length=255, blank=True, help_text="Identifier."
    )  # TODO: add CONTENT_IDENTIFIER
    ...
    def __str__(self):
        return "section: {}, language: {}, key: {} ({}): {}".format(
...
class Tag(models.Model):
    tag = models.CharField(
        max_length=255, unique=True, help_text="A tag, can be used by the works of art."
    )
...
class Artist(models.Model):
    ...
    link = models.CharField(
        max_length=255, help_text="The link; please leave as is - will be removed."
    )  # TODO: this should be a slug
...
class Art(models.Model):
    ...
    artist = models.ForeignKey(
        Artist, help_text="The artist.", on_delete=models.CASCADE
    )
    image = models.ImageField(
        upload_to="art", help_text="The image of the work of art."
    )
    land_price = models.ForeignKey(
        LandPrice,
    ...
    in_private_collection = models.BooleanField(
        default=False, help_text="Set this when the work is sold, or unavailable."
    )
    archived = models.BooleanField(
        default=False, help_text="If set the art will be part of the archive section."
    )
