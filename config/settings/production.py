...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["imagery.elevenbits.be"])
...
# Static and Media Assets go to S3
# ------------------------
...
DEFAULT_FROM_EMAIL = env(
    "DJANGO_DEFAULT_FROM_EMAIL", default="imagery <noreply@imagery.elevenbits.be>"
)
EMAIL_SUBJECT_PREFIX = env("DJANGO_EMAIL_SUBJECT_PREFIX", default="[imagery] ")
...
LOGGING = {
    ...
    "root": {"level": "INFO", "handlers": ["sentry"]},
    "formatters": {
        "verbose": {
